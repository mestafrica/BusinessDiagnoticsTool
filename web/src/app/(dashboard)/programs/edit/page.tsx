...
export default function EditProgram() {
  return (
    ...
    <div className="inline-block">
      <Link href={'/programs'} className="flex  items-center gap-2 rounded-lg text-sm text-black  hover:bg-gray-300 px-3 py-2  transition-all duration-200 ">
      ...
      <div className="mt-6 bg-white p-4 shadow-lg rounded-lg text-black">
        <h1 className=" text-xl ml-6  font-bold">Edit Program</h1>
        <p className="mt-2 ml-6 text-gray-700 text-sm">Update the program information below</p>
          ...
          <form action="" className="space-y-6 mt-4">
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2  gap-8">
              ...
              <div className=" flex flex-col justify-between">
                ...
                <select name="" id="" className="w-full text-sm text-gray-700 rounded-md px-2 py-1 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div className=" mt-4 w-[95%] mx-auto" >
         ...
         <div className=" mt-4 w-[95%] mx-auto text-black ">
          ...
          <div className=" flex  gap-6 w-[95%] mx-auto mt-6 mb-10">
            <button className="bg-black text-white px-4 py-2 rounded-lg cursor-pointer">Update program</button>
