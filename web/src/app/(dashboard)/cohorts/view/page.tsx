 ...
 <div className="p-6 sm:p-10 min-h-screen bg-gray-100 dark:bg-[#0b0c10] text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-[#1a1d24] p-6 rounded-2xl shadow-md">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          The MEST Cohort 2025 focuses on empowering early-stage tech
          entrepreneurs with training in software development, business strategy,
          and product management. Participants are guided by mentors to build
          viable solutions that promote innovation in Africa.
        </p>
      </div>
    </div>
    </>
